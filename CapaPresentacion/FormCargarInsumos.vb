...
Public Class FormCargarInsumos
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        If cmbInsumo.Text = "EI1 Encuesta de inventarios" Then
            If File.Exists("D:\OneDrive - Grupo EPM\Descargas\prueba\EI1_ENCUESTA_INVENTARIOS.xlsx") Then
        ...
        ElseIf cmbInsumo.Text = "PI1 Inventario planes" Then
            If File.Exists("D:\OneDrive - Grupo EPM\Descargas\prueba\PI1_INVENTARIO_PLANES.xlsx") Then
                If MessageBox.Show("El formato ya se encuentra cargado en el sistema, desea reemplazarlo?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                    ...
                    If cantErrores = 0 Then
                        Dim destino As String = "D:\OneDrive - Grupo EPM\Descargas\prueba\PI1_INVENTARIO_PLANES.xlsx"
                        Try
        ...
        ElseIf cmbInsumo.Text = "PI3 Inventario proyectos" Then
            If File.Exists("D:\OneDrive - Grupo EPM\Descargas\prueba\PI3_INVENTARIO_PROYECTOS.xlsx") Then
                If MessageBox.Show("El formato ya se encuentra cargado en el sistema, desea reemplazarlo?", "Confirmar", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = DialogResult.Yes Then
                    validarPI3()
                Else
                    MessageBox.Show("No se realizo ningun cambio.")
    ...
    Private Sub validarPI3()
        ...
        Next
        If cantErrores = 0 Then
            Dim destino As String = "D:\OneDrive - Grupo EPM\Descargas\prueba\PI3_INVENTARIO_PROYECTOS.xlsx"
            Try
                IO.File.Delete(destino)
                IO.File.Copy(txtRuta.Text, destino)
                cmbsheets.Items.Clear()
        ...
        End If
        If capturoCatch = 0 Then
            MessageBox.Show("Registros cargados: " & contador + cantErrores & vbCrLf & "Registro sin errores: " & contador & vbCrLf & "Errores encontrados: " & cantErrores & vbCrLf & cadenaError, "Registro exitoso", MessageBoxButtons.OK, MessageBoxIcon.Information)
            txtRuta.Text = ""
            cmbsheets.Text = ""
            DataGridView1.DataSource = ""
            btnGuardar.Enabled = False
